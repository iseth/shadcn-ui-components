...
class LinkComponentTest < ViewComponent::TestCase
  test "renders button with custom class" do
    render_inline(UI::Link::Component.new(href: "#", variant: :primary, class: "custom-class")) do
      "Click me"
    end
  ...
  test "renders button with icon" do
    render_inline(UI::Link::Component.new(href: "#", variant: :primary, icon: true)) do |component|

...
class BuilderAspectRatioComponentTest < ViewComponent::TestCase
  test "renders aspect ratio component with custom class" do
    render_inline(Ui::AspectRatio::BuilderAspectRatioComponent.new(aspect_ratio: "16/9", class: "custom-class")) do |component|
  ...
  test "calculates padding bottom correctly" do
    component = Ui::AspectRatio::BuilderAspectRatioComponent.new(aspect_ratio: "16/9")

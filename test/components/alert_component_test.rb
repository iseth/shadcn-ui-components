...
class BuilderAlertComponentTest < ViewComponent::TestCase
  test "renders warning alert with custom classes" do
    render_inline(Ui::Alert::BuilderAlertComponent.new(variant: :warning, class: "custom-class", classTitle: "custom-title-class", classDescription: "custom-description-class")) do |component|

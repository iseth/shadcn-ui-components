...
class BuilderAlertComponentTest < ViewComponent::TestCase
  test "renders warning alert with custom classes" do
    component = render_inline(Alert::BuilderAlertComponent.new(variant: :warning, class: "custom-class", classTitle: "custom-title-class", classDescription: "custom-description-class")) do |component|

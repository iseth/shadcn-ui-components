...
class ButtonComponentPreview < ViewComponent::Preview
  ...
  def icon
    render(Ui::ButtonComponent.new(variant: :outline, icon: true)) do |component|
  ...
  def with_icon_and_text
    render(Ui::ButtonComponent.new(variant: :primary, icon: true)) do |component|
      component.with_icon do
  ...
  def with_icon_2
    render(Ui::ButtonComponent.new(variant: :primary, icon: true, disabled: true)) do |component|
      component.with_icon do
  ...
  def submit
    render(Ui::ButtonComponent.new(variant: :primary, icon: true, type: :submit)) do |component|
      "Click me"
    end
  end

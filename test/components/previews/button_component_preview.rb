...
class ButtonComponentPreview < ViewComponent::Preview
  ...
  def with_icon
    render(ButtonComponent.new(variant: :primary,icon: true)) do |component|
  ...
  def with_icon_2
    render(ButtonComponent.new(variant: :primary,icon: true, disabled: true)) do |component|
      component.with_data do
        "Click me"
      end
      component.with_dataIcon do
        tag.svg xmlns: "http://www.w3.org/2000/svg", fill: "currentColor",viewBox: "0 0 20 20", class: "w-4 h-4 mr-2 animate-spin" do

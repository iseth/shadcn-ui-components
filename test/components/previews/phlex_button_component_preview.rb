...
class PhlexButtonComponentPreview < ViewComponent::Preview
  ...
  def with_icon
    render(PhlexButtonComponent.new(text: "With Icon", variant: :outline, icon: -> {
  ...
  def with_spinner
    render(PhlexButtonComponent.new(text: "Please wait", variant: :primary, disabled: true, icon: -> {
                                                                                                    tag.svg xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", class: "w-4 h-4 mr-2 animate-spin" do

...
class LinkComponentPreview < ViewComponent::Preview
  def default
    render(UI::Link::Component.new) do
      "Click me"
    end
  end

  def primary
    render(UI::Link::Component.new(href: "#", variant: :primary)) do
      "Click me"
    end
  end

  def destructive
    render(UI::Link::Component.new(href: "#", variant: :destructive)) do
      "Click me"
    end
  end

  def outline
    render(UI::Link::Component.new(href: "#", variant: :outline)) do
      "Click me"
    end
  end

  def ghost
    render(UI::Link::Component.new(href: "#", variant: :ghost)) do
      "Click me"
    end
  end

  def link
    render(UI::Link::Component.new(href: "#", variant: :link)) do
      "Click me"
    end
  end

  def icon
    render(UI::Link::Component.new(href: "#", variant: :outline, icon: true)) do |component|
  ...
  def with_icon_and_text
    render(UI::Link::Component.new(href: "#", variant: :primary)) do |component|
      component.with_icon do
  ...
  def with_icon_2
    render(UI::Link::Component.new(href: "#", variant: :primary, icon: true, disabled: true)) do |component|
      component.with_icon do
  ...
  def submit
    render(UI::Link::Component.new(href: "#", variant: :primary, type: :submit)) do |component|
      "Click me"
    end
  end

  def custom
    render(UI::Link::Component.new(href: "#", icon: true, position: "right", class: "whitespace-nowrap inline-flex items-center justify-center rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-destructive text-primary-foreground shadow hover:bg-indigo-500")) do |component|
      component.with_icon do
        tag.svg xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", class: "w-5 h-5" do
          tag.path fill_rule: "evenodd", d: "M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z", clip_rule: "evenodd"
        end

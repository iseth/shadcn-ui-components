class PhlexAlertComponentPreview < ViewComponent::Preview
  def default
    render PhlexAlertComponent.new(
      title: "Pro tip",
      description: "With PhlexUI you'll ship faster.",
      icon: -> { tag.svg xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", class: "w-5 h-5" do
